...
// WithUppercaseVariant is used to change the enum const values generated to not have the enum on them.
func (g *Generator) WithUppercaseVariant() *Generator {
	g.uppercaseLookup = true
	return g
}
